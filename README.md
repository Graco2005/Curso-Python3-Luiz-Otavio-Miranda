...
Este repositório contém todos os meus códigos, anotações e exercícios desenvolvidos ao longo do curso de Python. O objetivo é registrar meu aprendizado diário e construir uma base sólida na linguagem.
...
Para manter tudo organizado, os arquivos estão separados da seguinte forma:
...
1. Clone este repositório no seu computador:
   ...
   ```
2. Navegue até a pasta do módulo desejado e execute o arquivo Python:
   ```bash
...
* *Dica:* Lembre-se sempre de criar ambientes virtuais (`venv`) para projetos mais avançados que exigirem bibliotecas externas!
